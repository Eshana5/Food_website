...
$sql="INSERT INTO `food`.`order` (`Name`, `Email`, `Mobile`, `Items`, `Quantity`, `Address`, `Date`) VALUES ('$Name', '$Email', '$Mobile', '$Items', '$Quantity', '$Address', current_timestamp());";
...
<br><br><br><br><h1 align="center"><b> ENTER ORDER DETAILS</b></h1><br>
...
<tr>
<td width="20%">Name</td>
<td width="40%"><input type="text" Name="Name" placeholder="Name"></td>
</tr>
<td>Email</td>
...
<td>Item Names</td>
<td><input type="text" Name="Items" placeholder="Items"></td>
</tr>
<td>Quantity</td>
<td>
...
<td></td>
<td><a href="Thanks.html"><button class="SUBMIT">SUBMIT</button></a></td>
</tr>
</table></center></form>
</div>
<?php
